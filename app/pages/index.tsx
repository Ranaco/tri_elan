  ...
  return (
    <Section>
      <Stack alignItems={"center"} justifyContent={"center"}>
        ...
        />
        <Carousel>
          <CarouselChild text="Hello there" color="pink" />
          <CarouselChild text="Hello there" color="red" />
          <CarouselChild text="Hello there" color="teal" />
          <CarouselChild text="Hello there" color="blue" />
          <CarouselChild text="Hello there" color="violet" />
          <CarouselChild text="Hello there" color="yellow" />
          <CarouselChild text="Hello there" color="yellow" />
          <CarouselChild text="Hello there" color="yellow" />
          <CarouselChild text="Hello there" color="yellow" />
        </Carousel>
